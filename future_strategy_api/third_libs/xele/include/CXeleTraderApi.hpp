...
public:
    ...
    ///删除接口对象本身
    ///@remark 不再使用本接口对象时,调用该函数删除接口对�?
    virtual void Release() = 0;

    ///初始�?
    ///@remark 初始化运行环�?只有调用�?接口才开始工�?
    ...
    //设定自主协议报单模式. �? 如果要调用此函数，要在Init(false);之前调用.
